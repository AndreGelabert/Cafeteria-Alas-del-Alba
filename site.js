...
const translations = {
  pt: {
    ...
    product1Price: "R$ 8,00",
    product2: "Alfajores da Casa",
    product2Desc: "Um clássico irresistível. Feitos à mão todos os dias para serem o acompanhamento perfeito para sua infusão favorita.",
    product2Price: "R$ 14,00 - 25,00",
    ...
    catalogConstruction: "Catálogo completo em construção",
    ...
    locationHoursText: "Todos os dias<br/>8:15 AM - 11:30 AM<br/>15:30 PM - 19:30 PM",
  ...
  es: {
    ...
    product1Price: "R$ 8,00",
    product2: "Alfajores de la Casa",
    product2Desc: "Un clásico irresistible. Elaborados a mano todos los días para ser el acompañamiento perfecto de tu infusión favorita.",
    product2Price: "R$ 14,00 - 25,00",
    ...
    catalogConstruction: "Catálogo completo en construcción",
    ...
    locationHoursText: "Todos los días<br/>8:15 AM - 11:30 AM<br/>15:30 PM - 19:30 PM",
...
function checkOpenStatus() {
  ...
  const isOpen = (currentTime >= 8.15 && currentTime < 11.5) || (currentTime >= 15.5 && currentTime < 19.5);
